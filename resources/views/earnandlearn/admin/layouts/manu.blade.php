...
<div class="container-fluid topnav">
    <div class="row justify-content-center">
        <nav class="navbar bg-info ">
            ...
            <ul class="navbar-nav ">
                <li class="nav-item ">
                    <a href="/somadan" class="nav-link ">somadan</a>
                </li>
            </ul>
        </nav> 
    ...
    <div id="mySidenav" class="sidenav text-uppercase bg-info">
        ...
        <a href="{{ url('/somadan')}}">home</a>
        @foreach($cataghory as $key =>$catalist)
        <a href="{{url('/somadan/a/wproot/'.$catalist->main_content)}}" class="acatalist_manu"> {{ $catalist->main_content}}</a>
        @endforeach
